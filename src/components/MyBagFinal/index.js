...
function MyBagFinal() {
  ...
  const [proceeddiv, setproceeddiv] = useState(true);
  ...
  const [isPaymentDetailsVisible, setisPAyment] = useState(false);
  ...
  const [clientpaymentkey, setClientpaymentkey] = useState(null);
  ...
  console.log(isPaymentDetailsVisible,"ispaymentvisible")
  ...
  useEffect(() => {
    const fetchBagAndKeys = async () => {
      setLoading(true);

      try {
        const ids = localStorage.getItem("ManufacturerId__c");
        console.log(ids, "ids");
        ...
        if (ids?.length > 0) {
          ...
          const AccountId = localStorage.getItem("AccountId__c");
          const response = await getSkKeys(ids, token, AccountId);
          console.log(response, "response");
          setPaymentDetails({
            publishableKey: response.publishableKey,
            secretKey: response.secretKey,
          });
          setClientpaymentkey(response.secretKey);
          setBillingaddress(response.billingAddress);
          setBillingphone(response.phoneNumber);
        }
      } catch (error) {
                  ...
                  <div className="col-lg-5 col-md-4 col-sm-12">
                    <div className={Styles.ShippControl}>
                      ...
                      >
                        ...
                        {iconVisible && (
                          <FontAwesomeIcon
                            icon={proceeddiv ? faAngleUp : faAngleDown}
                          />
                        )}
                      </h2>
                        ...
                        {isPaymentDetailsVisible && (
                          <div className={Styles.Accordion}>
                            <StripePay
                              ...
                              orderDes={orderDesc}
                              PONumber={PONumber || limitInput}
                              PK_KEY={paymentDetails.publishableKey}
                              SK_KEY={clientpaymentkey}
                      ...
                      <div className={Styles.ShipBut}>
                        ...
                        <p
                          ...
                          style={{ textAlign: "center", cursor: "pointer", marginTop:"10px" }}
                          onClick={() => {
                            setClearConfim(true);
                          }}
                          disabled={!buttonActive}
